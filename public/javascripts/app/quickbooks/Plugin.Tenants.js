    ...
    function _loadGrid() {
        ...
        $("#Grid").ejGrid({
            ...
            columns: [
                ...
                { field: "EmployeeID", headerText: "Employee ID", textAlign: ej.TextAlign.Right, width: 75, priority: 2 },
                { field: "Freight", headerText: "Freight", textAlign: ej.TextAlign.Right, width: 75, format: "{0:C}", priority: 3 },
                { field: "OrderDate", headerText: "Order Date", width: 80, textAlign: ej.TextAlign.Right, format: "{0:MM/dd/yyyy}", priority: 4 },
